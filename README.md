...
AutoFram:Toggle("Marine Cap Notification",false,function(v)
	Bool = v
	if game.Players.LocalPlayer.Backpack:FindFirstChild("Marine Cap") then
		HaveMarineCap = true
	elseif game.Players.LocalPlayer.Character:FindFirstChild("Marine Cap") then
		HaveMarineCap = true
	end
	if HaveMarineCap and Bool == true then
        DiscordLib:Notification("Notification", "!! You Got Mairine Cap !!", "Wow !")
		while wait() do 
		                                        game.StarterGui:SetCore("SendNotification", {
                                        Title = "Blacky Notification", 
                                        Text = "You Get Marine Cap !!",
                                        Icon = "",
                                        Duration = 3
                                    })
end

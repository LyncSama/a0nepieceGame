...
local args = {
    [1] = "Devil Fruit",
    [2] = "Q",
    [3] = CFrame.new(-612.6448364257812, -2.7093913555145264, -4320.56640625) * CFrame.Angles(-2.2431657314300537, 0.19618894159793854, 2.901463031768799),
...
local TweenService = game:GetService("TweenService")
local Tw = TweenService:Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out,0,false,0), 
{CFrame = CFrame.new(-479.3429260253906, 490.8210754394531, -4726.77294921875)}):Play()
           end)
         end
     end
end)
